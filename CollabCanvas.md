...
The basic requirements aren't just about features — it’s about proving your foundation is solid. A simple canvas with bulletproof multiplayer is worth more than a feature-rich canvas with broken sync.
...
* Frontend: React with Konva.js or HTML5 Canvas  
* AI Integration: OpenAI GPT-4 (function calling support)
...
We recommend deploying on **Vercel** for simplicity.
